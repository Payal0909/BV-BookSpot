<%-- 
    ...
    Created on : 5 Apr, 2022, 5:41:46 PM
    Author     : DELL
--%>
...
%>
  ...
  <div class="container-fluid">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <h2>Welcome <%=Aname%></h2>
        <div class="main">
            <div class="heading"><h1>Seller Details: </h1></div>
            ...
            rst = pstmt.executeQuery();
             while (rst.next()) {
                   String sid = rst.getString("s_id");
                    ...
                    String semail=rst.getString("s_email");
                    String sphno=rst.getString("s_phone");
                    String saddress=rst.getString("s_address");
                %>
                <tr id="<%=sid%>">
                <td><%=sid%></td>
                <td><%=sname%></td>
