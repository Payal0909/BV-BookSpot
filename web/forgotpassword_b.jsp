<%-- 
    Document   : forgotpassword_b
    Created on : 23 Apr, 2022, 8:01:05 PM
    Author     : DELL
--%>
...
<!--                    <label >Email :</label>-->
    ...
    try{
        ...
        String query = "";
            ...
            query="Select b_id,b_email from buyer where b_id=? and b_email=?";  
             PreparedStatement pst = conn.prepareStatement(query);
                pst.setString(1, Userid);
                pst.setString(2, email);
                ResultSet rs = pst.executeQuery();                      
                 if(rs.next())        
                     response.sendRedirect("resetpassword_b.jsp");        
                 else
                 {
                   %>
                        <script>
                            alert("Invalid userid or password"); 
                            window.location= "forgotpassword_b.jsp";
                        </script>
